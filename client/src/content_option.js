...
const meta = {
    title: "XHunter",
    description: "I’m hardcore gamer with a mission of recording gameplays of every Nintendo switch game possible",
};
...
const dataportfolio = [{
    ...
    },
    {
        ...
        description: "Join Kirby in an unforgettable journey through a mysterious world in a 3D platforming adventure",
    ...
    },
    {
        ...
        description: "Traverse islands packed with platforming perfection and nonstop action",
    ...
    },
    {
        ...
        description: "Spin, jump, wump and repeat as you take on the epic challenges",
        link: "https://www.youtube.com/watch?v=Y53JPo_2zLI",
    },
    {
        img: "https://upload.wikimedia.org/wikipedia/en/f/f7/Metroid_Dread_Banner.png",
        description: "Parkour over obstacles, slide through tight spaces, counter enemies, and battle your way through the planet.",
        link: "https://www.youtube.com/watch?v=AOvefm5U250",
    },

    {
        img: "https://upload.wikimedia.org/wikipedia/en/e/eb/Cuphead_%28artwork%29.png",
        description: "Experience the classic run and gun action with a pal in 2-player local co-op",
        link: "https://www.youtube.com/watch?v=XwF67xkNSn8",
    },
    {
        img: "https://upload.wikimedia.org/wikipedia/en/f/f0/Unravel_2_cover_art.jpg",
        description: "Begin your adventure in a cold and imposing land, then watch your surroundings blossom with new life as you chase the spark of adventure",
        link: "https://www.youtube.com/watch?v=JOIn34q_oT8",
    },
    {
        img: "https://upload.wikimedia.org/wikipedia/en/3/38/Luigi%27s_Mansion_3.jpg",
        description: "Luigi's invited to the towering Last Resort hotel, but when Mario and friends go missing, our green-clad hero will have to conquer his fears to save them.",
    ...
    },
    {
        ...
        description: "Brave hundreds of hand-crafted challenges in this super-tight platformer, as you help Madeline survive her journey to the top of Celeste Mountain!",
    ...
    },
    {
        ...
        description: "Wield wild weapons and execute deadly moves—like the powerful Umbran Climax—to take out angels and demons",
